		...
		<div class="footer-grid">
			...
			<div class="footer-brand">
				...
				<div class="footer-social" style="margin-top:20px;">
					<a href="<?php echo esc_url( mage_contact( 'instagram' ) ); ?>" aria-label="Instagram" rel="noopener noreferrer" target="_blank">
					...
					<a href="<?php echo esc_url( mage_contact( 'linkedin' ) ); ?>" aria-label="LinkedIn" rel="noopener noreferrer" target="_blank">
